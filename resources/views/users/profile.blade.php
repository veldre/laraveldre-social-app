...
@section('content')
    ...
    <div class="container-fluid d-inline-flex">
        <div class="col-md-3 pt-4 profile-info">
            ...
            <a href="{{route('users.change-password-form')}}"
               class="btn btn-success btn-sm btn-block text-uppercase mt-3">Change password</a>
            <form action="{{route('users.destroy')}}" method="post" class="form-group">
                <button class="btn btn-danger btn-sm btn-block text-uppercase mt-3" type="submit"
